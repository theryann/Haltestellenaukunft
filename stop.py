...
class Haltestelle:
    ...
    margin_min = 400
    margin_departure_time = 50

    # Pivot Haltestelle
    haltestelle_text = Label(text = stop, fg = "Yellow", bg=bg_color, font=(font_face, 30))
    ...
    for line in departures:
        ...
        if line['arrival'] <= 60:
            ...
            min_text = str(line['arrival'] // 60) + 'h ' + str(line['arrival'] % 60) + 'min'
